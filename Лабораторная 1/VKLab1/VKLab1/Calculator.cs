    ...
    public partial class Calculator : Form
    {
        ...
        private void buttonCalculate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (height > 176 || bust > 98 || waist > 78 || hip > 104)
                {
                    throw new Exception();
                }
            }
            ...
            {
                MessageBox.Show("Введите целые числа для ваших физических размеров!", "Ошибочка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (ArgumentException)
            {
                MessageBox.Show("Введите положительные числа для ваших физических размеров!", "Ошибочка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (Exception)
            {
                MessageBox.Show("К сожалению, калькулятор предназначен только для размеров XS-XL.", "Ошибочка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            ...
            {
                MessageBox.Show("Введите целое число, равное вашему размеру ступни!", "Ошибочка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (Exception)
            {
                MessageBox.Show("Введите положительные числа для размера вашей ступни (от 22 - 27 см) !", "Ошибочка", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
